          ...
          <div className="flex sticky bottom-0 w-full px-6 pb-6 h-24">
            <div className="w-full relative">
              <textarea
                ...
                className="w-full h-full resize-none rounded-full border border-slate-900/10 bg-white pl-6 pr-24 py-[25px] text-base placeholder:text-slate-400 focus:border-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-500/10 shadow-[0_10px_40px_0px_rgba(0,0,0,0.15)]"
                onKeyDown={(e) => {
              ...
              <button
                ...
                className="flex w-14 h-14 items-center justify-center rounded-full px-3 text-sm  bg-blue-600 font-semibold text-white hover:bg-blue-700 active:bg-blue-800 absolute right-2 bottom-2 disabled:bg-blue-100 disabled:text-blue-400"
                type="submit"
                aria-label="Send"
